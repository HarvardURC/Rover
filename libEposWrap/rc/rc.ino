...
void loop() {
  ...
  ch4 = pulseIn(8, HIGH); //CHANGE missing ch4(idk what pin it is) gonna say its 7 for now
  forwardBackwardSwitch = pulseIn(5, HIGH);  //swtich to forward  (SFswitch ch5 on reciever)
  chswitch = pulseIn(6, HIGH); // three way swtich for grabber  979-1480ish-1991 (three states) ch6 on reciever
  int speed = map(ch1, 980, 2000, 1000, 3000); //this is the speed mapping CHANGE last argument to increase speed
